...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepkorea.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'EFhfaejPAhXexCtRW9YCQ5FPXdMq4guLteUZyvmJsME',
        yandex: '417c4c709a7939ec',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "url": "https://bokepkorea.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Bocil Ngentot Jilbab Smp Mama Viral Sma Tante Live Paksa Bokep Abg Jepang Jav Barat Korea China Terbaru`,
        "image": "https://bokepkorea.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepkorea.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepkorea.pages.dev/?q={search_term}", 
